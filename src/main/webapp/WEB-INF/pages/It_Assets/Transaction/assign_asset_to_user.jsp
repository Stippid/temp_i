...
<form:form name="MainAssets" id="MainAssets" modelAttribute="ViewAssetsCmd">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-md-6">
							...
							<div class="row form-group">
								<div class="col-md-3">
									<label class="form-control-label">Assign To User</label>
								</div>
								<div class="col-md-8">
						...
						<div class="row form-group">
							<div class="col-md-3">
								<label class=" form-control-label "><strong
									class="color_red">* </strong>Asset ID</label>
							</div>
							<div class="col-md-8">
								<input type="text" id="redg_no" name="redg_no"
									class="form-control autocomplete" autocomplete="off" readonly="readonly" value="${ViewAssetsCmd.assetid}">
							</div>
						</div>
					</div>
                    ...
                    <div class="container-fluid" align="center">
                        <div id="maindetailsdiv">
                            <div class="card">
								...
								><b>VIEW COMPUTING ASSET</b></a>
						</h4>
                                        </div>
                                        <div id="collapse1app" class="panel-collapse collapse">
                                            <div class=" ">
                                                <div id="getSearch_Letter">
                                                   <div class=" card-block" id="printableArea">
...
<!-- 						</div> -->
			...
			<div class="card-footer" align="center">
				<a href="search_asset_assignurl" class="btn btn-primary btn-sm" id="btn_clc">Back</a>
		<input type="button" class="btn btn-success btn-sm" id="searchbtn" name="searchbtn" value="Save"/>
						</div>
...
<c:url value="assignTouserChange" var="assignUrl" />
...
document.addEventListener('DOMContentLoaded', function() {
	...
	document.getElementById('app_final').onclick = function() {
		  divN(this);
	};
	document.getElementById('searchbtn').onclick = function() {
		if(validate())
			{
			 $("#assetId").val('${ViewAssetsCmd.id}');
...
function validate(){
	if($("#user_name").val().trim()=="")
		{
		alert("Please Enter UserName To Issue Asset");
		$("#user_name").focus();
			return false;
		}
	return true;
...
function divN(obj){	
	...
	setupAutocomplete("input#user_name", "#section");
