...
<div class="" align="center">
	<div class="card">
		...
		<div class="card-footer" align="center">
			<a href="Search_PeripheralUrl" class="btn btn-primary btn-sm"
	...
	<form:form action="${Search_PeripheralUrl_1}" method="post"
		id="searchForm" name="searchForm" modelAttribute="machine_make1">
		...
		<input type="hidden" name="year_of_manufacturing1"
			id="year_of_manufacturing1" value="0" />
	...
	<form:form action="${updateUrl}" method="post" id="updateForm"
		...
		<input type="hidden" name="screenurl5" id="screenurl5"
			value="Search_PeripheralUrl" />
	</form:form>
	...
	<form:form action="${deleteUrl}" method="post" id="deleteForm"
		...
		<input type="hidden" name="screenurl6" id="screenurl6"
			value="Search_PeripheralUrl" />
	</form:form>
	...
	<form:form action="${viewUrl}" method="post" id="viewForm"
		...
		<input type="hidden" name="screenurl7" id="screenurl7"
			value="Search_PeripheralUrl" />
	</form:form>
	...
	<form:form action="${archiveUrl}" method="post" id="archiveForm"
		...
		<input type="hidden" name="screenurl8" id="screenurl8"
			value="Search_PeripheralUrl" />
	</form:form>
...
// 		return onlyAlphaNumeric(event, this);
//   	};
	document.getElementById('s_state').onkeypress = 
		function() {
