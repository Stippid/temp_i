		...
		<div class="col-md-12" align="center">
			<div class="card">
				<div class="card-header">
					<h5>UNSERVICEABLE ASSETS REPORT</h5>
...
<%-- 									<form:input type="text" id="b_code" path="b_code" class="form-control autocomplete" autocomplete="off"></form:input> --%>
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="Unserviceable_Report_url"
				...
				<table id="getSearch_All_India_Holding"
					...
					<thead>
						...
						<th id ="19">Command</th>
							...
							<th id ="15">label</th>
							<th id ="16">Unserviceable From Date</th>
							<th id ="17">Unserviceable To Date</th>
							<th id ="18">Days</th>
...
<c:url value="Download_All_India_Holding_Details1" var="dwonloadUrl" />
...
<c:url value="SearchAll_Holding1" var="SearchAll_Holding1" />
<form:form action="${SearchAll_Holding1}" method="post" id="searchForm" name="searchForm" modelAttribute="id7">
...
function data(getSearch_All_India_Holding){
	...
	$.post("getindiaholding1?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,cont_comd:cont_comd,cont_corps:cont_corps,cont_div:cont_div,cont_bde:cont_bde,unit_name:unit_name,sus_no:sus_no,asset_type:asset_type,
		a_type:a_type,b_head:b_head,b_code:b_code,a_type:a_type,
		},function(j) {
			
		for (var i = 0; i < j.length; i++) {
			
			jsondata.push([j[i].command,j[i].corps,j[i].div,j[i].bde,j[i].unit_name,j[i].sus_no,j[i].asset_cat,j[i].assets_name,j[i].make_name,j[i].model_name,j[i].model_number,j[i].machine_number,j[i].b_head,j[i].budget_code,j[i].label,j[i].unsv_from_dt,j[i].unsv_to_dt,j[i].days
			]);
	...
	$.post("getindiaholdingCount1?"+key+"="+value,{Search:Search,cont_comd:cont_comd,cont_corps:cont_corps,cont_div:cont_div,cont_bde:cont_bde,unit_name:unit_name,sus_no:sus_no,asset_type:asset_type,b_head:b_head,b_code:b_code,a_type:a_type,
		},function(j) {
		FilteredRecords = j;
	});
}
