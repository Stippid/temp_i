...
<form:form name="EditFormname" id="EditFormid"
	action="EditANTIVIRUSAction?${_csrf.parameterName}=${_csrf.token}"
	method="POST" modelAttribute="EditANTIVIRUSCMD">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>UPDATE ANTIVIRUS MASTER</h5>
			</div>
			<div class="card-body card-block cue_text">
				...
				<form:input type="hidden" id="id" path="id"
					value="${EditANTIVIRUSCMD1.id}"></form:input>
				<div class="row">
					<div class='col-md-6'>
						<div class='row form-group'>
							...
							<div class='col-12 col-md-8'>
								<form:input type="text" id="antivirus" path="antivirus"
									value="${EditANTIVIRUSCMD1.antivirus}"
			...
			<div class='card-footer text_align_center'>
				<a href="ANTIVIRUS_Url" class="btn btn-success btn-sm">Back</a> <input
...
<script nonce="${cspNonce}">
	...
	function isValidateClientSide() {
		...
		if ($("input#antivirus").val().trim() == "") {
			alert("Please Enter Antivirus Name");
			$("input#antivirus").focus();
			return false;
