...
<form:form name="EditFormname" id="EditFormid"
	action="Editos_mstrAction?${_csrf.parameterName}=${_csrf.token}"
	method="POST" modelAttribute="Editos_mstrCMD">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>UPDATE OPERATING SYSTEM MASTER</h5>
			</div>
			<div class="card-body card-block cue_text">
				...
				<form:input type="hidden" id="id" path="id"
					value="${Editos_mstrCMD1.id}"></form:input>
				<div class="row">
					<div class='col-md-6'>
			...
			<div class='card-footer' align='center'>
				<a href=Os_mstr_Url class="btn btn-success btn-sm">Back</a> <input
