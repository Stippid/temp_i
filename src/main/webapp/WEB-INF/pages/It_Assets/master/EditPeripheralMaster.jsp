...
<form:form name="EditFormname" id="EditFormid"
	action="EditPeripheralMasterAction?${_csrf.parameterName}=${_csrf.token}"
	method="POST" modelAttribute="EditPeripheralMasterCMD">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>UPDATE PERIPHERAL MASTER</h5>
			</div>
			<div class="card-body card-block cue_text">
				...
				<form:input type="hidden" id="id" path="id"
					value="${EditPeripheralMasterCMD1.id}"></form:input>
				<div class="row">
					<div class='col-md-6'>
						<div class='row form-group'>
							...
							<div class='col-12 col-md-8'>
								<form:input type="text" id="peripheral_type"
									...
									value="${EditPeripheralMasterCMD1.peripheral_type}"
			...
			<div class='card-footer' align='center'>
				...
				<a href="PeripheralMaster_Url" class="btn btn-success btn-sm">Back</a>
