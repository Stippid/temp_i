...
<form:form name="EditFormname" id="EditFormid"
	action="Editoffice_mstrAction?${_csrf.parameterName}=${_csrf.token}"
	method="POST" modelAttribute="Editoffice_mstrCMD">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>UPDATE OFFICE VERSION MASTER</h5>
			</div>
			<div class="card-body card-block cue_text">
				...
				<form:input type="hidden" id="id" path="id"
					value="${Editoffice_mstrCMD1.id}"></form:input>
				<div class="row">
					<div class='col-md-6'>
						<div class='row form-group'>
							...
							<div class='col-12 col-md-8'>
								<form:input type="text" id="office" path="office"
									value="${Editoffice_mstrCMD1.office}"
			...
			<div class='card-footer' align='center'>
				<a href=Office_mstr_Url class="btn btn-success btn-sm">Back</a> <input
