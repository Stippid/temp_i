...
<form:form name="EditFormname" id="EditFormid"
	action="Edittype_of_hw_mstrAction?${_csrf.parameterName}=${_csrf.token}"
	method="POST" modelAttribute="Edittype_of_hw_mstrCMD">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>UPDATE TYPE OF HARDWARE</h5>
			</div>
			<div class="card-body card-block cue_text">
				...
				<form:input type="hidden" id="id" path="id"
					value="${Edittype_of_hw_mstrCMD1.id}"></form:input>
				<div class="row">
					<div class='col-md-6'>
						...
						<div class='row form-group'>
							...
							<div class='col-12 col-md-8'>
								<form:input type="text" id="type_of_hw" path="type_of_hw"
									value="${Edittype_of_hw_mstrCMD1.type_of_hw}"
	...
	$(document).ready(
			function() {
				...
				$('select#peripheral_type').val(
						'${Edittype_of_hw_mstrCMD1.peripheral_type}');
				checkUPS();
			});
