...
<form:form name="Formname" id="Formid"
	action="ram_mstrAction?${_csrf.parameterName}=${_csrf.token}"
	method="POST" modelAttribute="ram_mstrCMD">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>RAM CAPACITY MASTER</h5>
			</div>
				...
				<div class='col-md-12'>
					...
					<div class='col-md-2'>
						<strong class="color_red">*</strong> <label for="text-input"
							class="form-control-label">RAM CAPACITY</label>
					</div>
					<div class='col-md-3'>
						<input type="text" id="ram" name="ram"
							class="form-control number text_transform_upper"
          ...
          <div class='col-12 col-md-6'>
			...
			<div class='card-footer' align='center'>
				<a href=Ram_mstr_Url class="btn btn-success btn-sm">Clear</a> <input
		...
		<div class="card-body">
			<div class="" id="divPrint">
				<div class="container" align="center">
					...
					<div class="col-md-12">
						<table id="ram_mstr_reporttbl" class="display">
							<thead>
								<tr>
									<th>RAM Capacity</th>
									<th>Action</th>
...
<script nonce="${cspNonce}">
	...
	function data(ram_mstr_reporttbl) {
		...
		$.post("getRam_mstrReportDataList?" + key + "=" + value, {
			startPage : startPage,
		...
		$.post("getRam_mstrTotalCount?" + key + "=" + value, {
			Search : Search,
			ram : ram,
			ram_capacity : ram_capacity
		}, function(j) {
