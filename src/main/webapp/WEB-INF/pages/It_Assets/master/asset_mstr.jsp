...
<form:form name="Formname" id="Formid"
	action="asset_mstrAction?${_csrf.parameterName}=${_csrf.token}"
	method="POST" modelAttribute="asset_mstrCMD">

	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>ASSETS CATEGORY MASTER</h5>
			</div>
		...
		<div class="card-body">
			<div class="" id="divPrint">
				...
				<div class="watermarked" data-watermark="" id="divwatermark">
					<table id="asset_mstr_reporttbl" class="display">
						<thead>
							<tr>
								<th>Category</th>
								<th>Assets Name</th>
...
<script nonce="${cspNonce}">
	...
	function data(asset_mstr_reporttbl) {
		...
		$.post("getAsset_mstrReportDataList?" + key + "=" + value, {
			startPage : startPage,
		...
		$.post("getAsset_mstrTotalCount?" + key + "=" + value, {
			Search : Search,
			assets_name : assets_name,
			category : category
		}, function(j) {
