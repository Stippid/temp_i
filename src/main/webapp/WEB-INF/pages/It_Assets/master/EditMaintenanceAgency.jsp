...
<form:form name="EditFormname" id="EditFormid" action="EditMAINTENANCEAction?${_csrf.parameterName}=${_csrf.token}" method="POST" modelAttribute="EditMAINTENANCECMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>UPDATE MAINTENANCE AGENCY MASTER</h5></div>
       <div class="card-body card-block cue_text">
<div class="col-md-12 display_none" id="divLine" ><span class="line"></span></div>
<form:input type="hidden" id="id" path="id" value="${EditMAINTENANCECMD1.id}" ></form:input>
 <div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-6'>
	           <strong class="color_red">*</strong> <label for="text-input" class="form-control-label">MAINTENANCE AGENCY NAME</label>
          </div>
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="maintenance" path="maintenance" value="${EditMAINTENANCECMD1.maintenance}"
       ...
       <div class='card-footer text_align_center' >
          <a href="maintenance_agency_Url" class="btn btn-success btn-sm">Back</a>
...
function ParseDateColumncommission(data) {
 ...
 function isValidateClientSide()
  ...
  if($("input#maintenance").val().trim() == "")
   {
	  alert("Please Enter Maintenance Name");
	  $("input#maintenance").focus();
	  return false;
