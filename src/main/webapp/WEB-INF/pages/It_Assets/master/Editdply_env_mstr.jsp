...
<form:form name="EditFormname" id="EditFormid"
	action="Editdply_env_mstrAction?${_csrf.parameterName}=${_csrf.token}"
	method="POST" modelAttribute="Editdply_env_mstrCMD">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>UPDATE DEPLOYMENT ENVIRONMENT MASTER</h5>
			</div>
			<div class="card-body card-block cue_text">
				...
				<form:input type="hidden" id="id" path="id"
					value="${Editdply_env_mstrCMD1.id}"></form:input>
				<div class="row">
					<div class='col-md-10'>
						<div class='row form-group'>
							<div class='col col-md-3'>
								<strong class="color_red">*</strong> <label for="text-input"
									class="form-control-label">DEPLOYMENT ENVIRONMENT</label>
							</div>
							<div class='col-12 col-md-6'>
								<form:input type="text" id="dply_env" path="dply_env"
									value="${Editdply_env_mstrCMD1.dply_env}"
			...
			<div class='card-footer' align='center'>
				<a href="Dply_env_mstr_Url" class="btn btn-success btn-sm">Back</a>
