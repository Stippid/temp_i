...
<form:form name="EditFormname" id="EditFormid"
	...
	modelAttribute="EditManagement_Layer_CMD">
				...
				<div class='col-md-8'>
					<div class='row form-group'>
						<div class='col col-md-4'>
							<strong class="color_red">*</strong> <label for="text-input" class="form-control-label">MANAGEMENT LAYER</label>
						</div>
						<div class='col-md-6'>
							<form:input type="text" id="management_layer"
								path="management_layer" class="form-control text_transform_upper" autocomplete='off'
