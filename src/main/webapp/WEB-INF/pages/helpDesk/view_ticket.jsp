...
<form:form name="viewticket" id="viewticket" action="viewticketAction?${_csrf.parameterName}=${_csrf.token}"
	method='POST' modelAttribute="viewticketCMD" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input typ id="date1" name="date1" class="form-control"
										 ></input> <input
...
<%-- 										value="${help_topic}"> --%>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									...
									<input
										...
										class="form-control" 
										value="${screen_shot}">
									<i id="download_id" class="fa fa-download display_none"> <span
										id="uploadedFileName" name ="uploadedFileName" class="uploaded-file-name f_10">${screen_shot}</span>
										<input type="button"
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<textarea  id="description"
										name="description" class="form-control autocomplete text_transform_upper"
				...
				<div class='card-footer' align='center'>
					<input id="update1" type="submit" class="btn btn-primary btn-sm"
						value="Update"> <i class="fa fa-print"></i><input
...
<script nonce="${cspNonce}">
	document.addEventListener('DOMContentLoaded', function() {
		...
		document.getElementById('download_id').onclick = 
			function() {
