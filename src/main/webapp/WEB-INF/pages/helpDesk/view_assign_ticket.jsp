...
<form:form name="viewticket" id="viewticket"
	action="assignviewticketAction?${_csrf.parameterName}=${_csrf.token}"
		...
		<div class="container" align="center">
			<div class="card">
				...
				<div class="card-body card-block">
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input id="date1" name="date1" class="form-control"
										value="${created_on}" readonly="readonly"></input> <input
										type="hidden" id=completed_dt name="completed_dt"
										class="form-control" value="${completed_dt}"></input> <input
								...
								<div class="col-md-8">
									...
									<div class="col-md-2 mt_10" id="d1">
										...
										<input type="hidden" id=hidFileName name="hidFileName"
											class="form-control" value="${screen_shot}"> <i
											id="download_id" class="fa fa-download display_none"
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									...
									<%-- <textarea rows="2" cols="250" id="description" name="description" class="h150 form-control char-counter1" autocomplete="off" maxlength="1000">${description}</textarea> --%>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col-md-4">
									<label for="text-input" class=" form-control-label">Assign
										User</label>
								</div>
								<div class="col-md-8">
								<select name="assignuser" id="assignuser" class="form-control ">
										<option value="0">--Select--</option>
										<c:forEach var="item" items="${getTypeofRoleList}"
											varStatus="num">
				...
				<div class='card-footer' align='center'>
					<input id="update1" type="submit" class="btn btn-success btn-sm"
						value="Approve"> <i class="fa fa-print"></i><input
	...
	$(document).ready(function() {
		...
		if (filename && filename.trim() !== "") {
			...
			$('#download_id').removeClass('display_none');
			 $('#download_id').prop('readonly', true);
		} else {
