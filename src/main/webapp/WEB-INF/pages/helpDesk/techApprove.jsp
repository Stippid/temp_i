...
<form:form name="viewticket" id="viewticket"
	action="resovedticketbyittecAction?${_csrf.parameterName}=${_csrf.token}"
			...
			<div class="card">
				...
				<div class="card-body card-block">
					...
					<div class="row">
						...
						<div class="col-md-6 display_none" id="remark_hid">
							<div class="row form-group">
								<div class="col-md-4">
				...
				value="Resolve Ticket Status"> <i class="fa fa-print"></i><input
