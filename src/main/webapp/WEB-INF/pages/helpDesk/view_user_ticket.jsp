					...
					<table id="TicketReport"
						...
						<thead>
							<tr>
								...
								<th class="width50">Issue Summary</th>
								<th class="lastCol width7 text_align_center">Action</th>
							</tr>
						</thead>
						<tbody>
							...
							<c:forEach var="item" items="${list}" varStatus="num">
								<tr>
									...
									<td class="width50">${item.issue_summary}</td>
									<td id="thAction1" class='lastCol width7 text_align_center'>${item.id}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
