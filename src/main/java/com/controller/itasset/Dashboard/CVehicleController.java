...
public class CVehicleController {
	...
	@RequestMapping(value = "/admin/cVehicleDashboard", method = RequestMethod.GET)
	public ModelAndView cVehicleDashboard(ModelMap Mmap, HttpSession session,
		...
		Mmap.put("msg", msg);
		Mmap.put("getcVehicleData",dashboardDao.getcVehicleData(formation_code,susno));
		return new ModelAndView("cVehicleDashboardTiles");
	}
}
