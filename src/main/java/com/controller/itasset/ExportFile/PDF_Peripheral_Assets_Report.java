...
import com.controller.itasset.ExportFile.PDF_All_India_Holding_Less.ImageBackgroundEvent;
...
public class PDF_Peripheral_Assets_Report extends AbstractPdfView {
	...
	public PDF_Peripheral_Assets_Report(List<String> TH,String username,String Heading,List<ArrayList<String>>list,int total){
		this.TH = TH;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("PERIPHERALS CENSUS REPORT :"+username, fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		p4.setColspan(8);
		table4.addCell(p4);
		Phrase ph = new Phrase(""+list.size());
		table4.addCell(ph);
