...
public class ExcelComputingUserListReportView extends AbstractXlsView{
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	
	public ExcelComputingUserListReportView(String Type,List<String> TH,String Heading,String username){
		this.Type = Type;
		this.TH = TH;
