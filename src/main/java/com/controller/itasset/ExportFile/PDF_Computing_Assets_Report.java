...
public class PDF_Computing_Assets_Report extends AbstractPdfView {
	...
	public PDF_Computing_Assets_Report(List<String> TH,String username,String Heading,List<ArrayList<String>>list,int total){
		this.TH = TH;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("IT CENSUS REPORT:"+username, fontTableHeadingMainHead);
