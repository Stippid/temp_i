...
public class ExcelPeripheralUserListReportView extends AbstractXlsView{
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	
	public ExcelPeripheralUserListReportView(String Type,List<String> TH,String Heading,String username){
		this.Type = Type;
		this.TH = TH;
